...
namespace ISTUDIO.Infrastructure.Migrations
{
    ...
    [Migration("20241006095408_DelMagIdShopping")]
    partial class DelMagIdShopping
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ISTUDIO.Domain.EntityModel.CustomerImagesEntity", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 10, 6, 9, 54, 5, 81, DateTimeKind.Utc).AddTicks(8914));
            ...
            modelBuilder.Entity("ISTUDIO.Domain.EntityModel.OrderEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 10, 6, 9, 54, 5, 87, DateTimeKind.Utc).AddTicks(1786));
            ...
            modelBuilder.Entity("ISTUDIO.Domain.EntityModel.OrderStatusHistoryEntity", b =>
                {
                    ...
                    b.Property<DateTime>("ChangeDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 10, 6, 9, 54, 5, 107, DateTimeKind.Utc).AddTicks(3896));
            ...
            modelBuilder.Entity("ISTUDIO.Domain.EntityModel.ProductsEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 10, 6, 9, 54, 5, 98, DateTimeKind.Utc).AddTicks(5288));
            ...
            modelBuilder.Entity("ISTUDIO.Infrastructure.Identity.AppUser", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 10, 6, 9, 54, 5, 81, DateTimeKind.Utc).AddTicks(2750));

...
namespace ISTUDIO.Infrastructure.Migrations
{
    ...
    [Migration("20241005153442_RefODetailsMagazine")]
    partial class RefODetailsMagazine
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ISTUDIO.Domain.EntityModel.CustomerImagesEntity", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 10, 5, 15, 34, 42, 380, DateTimeKind.Utc).AddTicks(3279));
            ...
            modelBuilder.Entity("ISTUDIO.Domain.EntityModel.OrderEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 10, 5, 15, 34, 42, 382, DateTimeKind.Utc).AddTicks(6879));
            ...
            modelBuilder.Entity("ISTUDIO.Domain.EntityModel.OrderStatusHistoryEntity", b =>
                {
                    ...
                    b.Property<DateTime>("ChangeDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 10, 5, 15, 34, 42, 391, DateTimeKind.Utc).AddTicks(1220));
            ...
            modelBuilder.Entity("ISTUDIO.Domain.EntityModel.ProductsEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 10, 5, 15, 34, 42, 387, DateTimeKind.Utc).AddTicks(7045));
            ...
            modelBuilder.Entity("ISTUDIO.Infrastructure.Identity.AppUser", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 10, 5, 15, 34, 42, 380, DateTimeKind.Utc).AddTicks(830));

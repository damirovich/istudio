...
namespace ISTUDIO.Infrastructure.Migrations
{
    ...
    [Migration("20250207145928_AddStories")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ISTUDIO.Domain.EntityModel.AppUpdateInfoEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppUpdateInfo", (string)null);
                });

            modelBuilder.Entity("ISTUDIO.Domain.EntityModel.BakaiCheckStatusResEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ISTUDIO.Domain.EntityModel.BakaiConfirmTranReqEntity", b =>
                {
                    ...
                    b.ToTable("BakaiConfirmTranReq", (string)null);
                });

            modelBuilder.Entity("ISTUDIO.Domain.EntityModel.BakaiConfirmTranResEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("BakaiConfirmTranRes", (string)null);
                });

            modelBuilder.Entity("ISTUDIO.Domain.EntityModel.BakaiCreateTranReqEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("BakaiCreateTranReq", (string)null);
                });

            modelBuilder.Entity("ISTUDIO.Domain.EntityModel.BakaiCreateTranResEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("BakaiCreateTranRes", (string)null);
                });
            ...
            modelBuilder.Entity("ISTUDIO.Domain.EntityModel.CashbackEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ISTUDIO.Domain.EntityModel.CashbackTransactionEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CashbackTransactions", (string)null);
                });
            ...
            modelBuilder.Entity("ISTUDIO.Domain.EntityModel.CustomerImagesEntity", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 2, 7, 14, 59, 25, 147, DateTimeKind.Utc).AddTicks(4365));
            ...
            modelBuilder.Entity("ISTUDIO.Domain.EntityModel.FreedomPayInitResEntity", b =>
                {
                    ...
                    b.Property<string>("RedirectUrlType")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.ToTable("FreedomInitPayResponses", (string)null);
                });

            modelBuilder.Entity("ISTUDIO.Domain.EntityModel.FreedomPayResultRequestEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("FreedomPayResultRequests", (string)null);
                });

            modelBuilder.Entity("ISTUDIO.Domain.EntityModel.FreedomPayResultResponseEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("FreedomPayResultResponses", (string)null);
                });
            ...
            modelBuilder.Entity("ISTUDIO.Domain.EntityModel.OrderDeliveryEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ISTUDIO.Domain.EntityModel.OrderPaymentEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ISTUDIO.Domain.EntityModel.OrderStatusEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("OrderStatusEntity", (string)null);
                });
            ...
            modelBuilder.Entity("ISTUDIO.Domain.EntityModel.OrderStatusHistoryEntity", b =>
                {
                    ...
                    b.Property<DateTime>("ChangeDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 2, 7, 14, 59, 25, 174, DateTimeKind.Utc).AddTicks(6285));
            ...
            modelBuilder.Entity("ISTUDIO.Domain.EntityModel.ProductCashbackEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("MaxBonusPercent")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("ISTUDIO.Domain.EntityModel.ProductsEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 2, 7, 14, 59, 25, 180, DateTimeKind.Utc).AddTicks(9038));
            ...
            modelBuilder.Entity("ISTUDIO.Domain.EntityModel.StoriesEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ISTUDIO.Domain.EntityModel.StoryContentEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("StoryId", "Queue")
                        .IsUnique();

                    b.ToTable("StoryContents", (string)null);
                });

            modelBuilder.Entity("ISTUDIO.Domain.EntityModel.UserCashbackEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ISTUDIO.Infrastructure.Identity.AppUser", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 2, 7, 14, 59, 25, 146, DateTimeKind.Utc).AddTicks(6931));
            ...
            modelBuilder.Entity("ISTUDIO.Domain.EntityModel.OrderDeliveryEntity", b =>
                {
                    b.HasOne("ISTUDIO.Domain.EntityModel.OrderAddressEntity", "OrderAddress")
                        .WithMany()
            ...
            modelBuilder.Entity("ISTUDIO.Domain.EntityModel.OrderDetailEntity", b =>
                {
                    b.HasOne("ISTUDIO.Domain.EntityModel.MagazineEntity", "Magazines")
            ...
            modelBuilder.Entity("ISTUDIO.Domain.EntityModel.OrderEntity", b =>
                {
                    b.HasOne("ISTUDIO.Domain.EntityModel.OrderStatusEntity", "Status")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("ISTUDIO.Domain.EntityModel.OrderPaymentEntity", b =>
                {
                    ...
                    b.HasOne("ISTUDIO.Domain.EntityModel.PaymentMethodEntity", "PaymentMethod")
            ...
            modelBuilder.Entity("ISTUDIO.Domain.EntityModel.ProductsEntity", b =>
                {
                    b.HasOne("ISTUDIO.Domain.EntityModel.CashbackEntity", "Cashback")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("ISTUDIO.Domain.EntityModel.StoryContentEntity", b =>
                {
                    b.HasOne("ISTUDIO.Domain.EntityModel.StoriesEntity", "Story")
                        .WithMany("StoryContents")
